...
Supports NVIDIA, AMD, and Intel GPUs with **real-time utilization sampling** — measures actual GPU load instead of assuming full TDP. Select a specific GPU with `gpu_index`:
...
# [EcoTrace] GPU Function : gpu_compute
